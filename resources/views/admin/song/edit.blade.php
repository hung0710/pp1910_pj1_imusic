...
{{-- <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{route('admin.products.update', ['product_slug' => $product->slug])}}" enctype="multipart/form-data"> --}}
    ...
    <div class="form-group">
        {{-- <label class="control-label col-md-3 col-sm-3 col-xs-12" for="price">Singer <span class="required">*</span></label> --}}
        <div class="col-md-6 col-sm-6 col-xs-12">
            {{-- <input type="text" name="price" value="{{ $song->Singer }}" class="form-control col-md-7 col-xs-12"> --}}
        </div>
    </div>
    {{-- <div class="form-group">
